...
public class THCSBTAdapter extends ArrayAdapter<LinkedHashMap<String, String>>  {
	...
	public THCSBTAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if(convertView == null){
			...
			convertView = inflater.inflate(R.layout.listview_thcsbt, null);
		}
