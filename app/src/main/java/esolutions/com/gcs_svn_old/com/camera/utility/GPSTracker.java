...
public class GPSTracker extends Service implements LocationListener {
	...
	private static final long MIN_TIME_BW_UPDATES = 0; // 5 sec
	...
	public Location getLocation() {
		try {
			...
			if (!isGPSEnabled && !isNetworkEnabled) {// && !isPassiveEnabled) {
				Common.ShowToast(getApplicationContext(), "Không thể định vị", 2000, 700);
			} else {
...
//				}
	...
	public void showSettingsAlert(){
        ...
        alertDialog.setMessage("GPS chưa bật. Bạn có muốn vào phần cài đặt GPS không ?");
