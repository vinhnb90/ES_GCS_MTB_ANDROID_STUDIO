...
import esolutions.com.gcs_svn_old.com.camera.ui.Activity_Camera_MTB;

/** An array adapter that knows how to render views when given CustomData classes */
public class CustomArrayAdapterCameraMTB extends ArrayAdapter<LinkedHashMap<String, String>> {
	private final Context context;
	public String filter_col = null;

	public CustomArrayAdapterCameraMTB(Context context, int resource, ArrayList<LinkedHashMap<String, String>> objects) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(Activity_Camera_MTB.pos_so == position){
