...
public class CustomArrayAdapterCamera extends ArrayAdapter<LinkedHashMap<String, String>> {
	private final Context context;
	public String filter_col = null;

	public CustomArrayAdapterCamera(Context context, int resource, ArrayList<LinkedHashMap<String, String>> objects) {
